...
#define Z_STEPPER_AUTO_ALIGN
  ...
  //#define Z_STEPPER_ALIGN_XY { {  38, 117 }, { 197,  117 } }
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       1050        // (mA) RMS current. Multiply by 1.414 for peak current. (70% of 1500mA)
  ...
  #if AXIS_IS_TMC(Y)
    #define Y_CURRENT       1050 // 70% of 1500mA
  ...
  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT       588 // 70% of 725mA
  ...
  #if AXIS_IS_TMC(Z2)
    #define Z2_CURRENT      588 // 70% of 725mA
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      1176 // 70% of 1680mA
    #define E0_MICROSTEPS    16
